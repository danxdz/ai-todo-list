...
const STRINGS = {
  en: {
    ...
    'retention.welcomeLine2': 'Merge identical atoms to climb the table.',
    ...
    'atoms.help':
      'Release to drop · merge the same element. Spheres show a Bohr-style shell hint.',
    'atoms.overlaySub': 'The reactor column hit critical fill.',
    'atoms.gameMenuIntro':
      'Merge same element · spheres show a Bohr-style shell hint (educational).',
  ...
  fr: {
    ...
    'retention.welcomeLine2': 'Fusionnez les mêmes atomes pour progresser dans la table.',
    ...
    'atoms.help':
      'Relâcher pour lâcher · fusionner le même élément. Coquilles façon Bohr.',
    'atoms.overlaySub': 'La colonne réacteur est trop pleine.',
    'atoms.gameMenuIntro':
      'Fusionnez le même élément · coquilles façon Bohr (pédagogique).',
  ...
  pt: {
    ...
    'retention.welcomeLine2': 'Una átomos iguais para avançar na tabela.',
    ...
    'atoms.help':
      'Solte para largar · una o mesmo elemento. Camadas estilo Bohr.',
    'atoms.overlaySub': 'A coluna do reator encheu demais.',
    'atoms.gameMenuIntro':
      'Una o mesmo elemento · camadas estilo Bohr (educativo).',
